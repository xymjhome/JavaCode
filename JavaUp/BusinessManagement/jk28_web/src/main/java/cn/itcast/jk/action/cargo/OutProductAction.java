...
public class OutProductAction extends BaseAction {
	...
	/*public String print() throws Exception {
	    ...
	    String hql= "from ContractProduct  where DATE_FORMAT(contract.shipTime,'%Y-%m') ='"+inputDate+"'";	//msql
		String hql= "from ContractProduct  where to_char(contract.shipTime,'yyyy-MM') ='"+inputDate+"'";  //orcal
	...
	public String print() throws Exception {
		...
		downUtil.download(baos, response, "test.xlsx");//如果是中文，下载时可能会产生乱码，如何解决？
