<%@ page import="com.project.servlet.utils.CookieUtils" %>
...
<html>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				<a href="/WebProjectCaseTest/getProductById?id=1">
					<img src="products/1/cs10001.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/WebProjectCaseTest/getProductById?id=1" style='color:green'>衣服</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/WebProjectCaseTest/getProductById?id=2">
					<img src="products/1/cs10002.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/WebProjectCaseTest/getProductById?id=2" style='color:green'>眼镜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/WebProjectCaseTest/getProductById?id=3">
					<img src="products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/WebProjectCaseTest/getProductById?id=3" style='color:green'>包</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/WebProjectCaseTest/getProductById?id=4">
					<img src="products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/WebProjectCaseTest/getProductById?id=4" style='color:green'>手机</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			<div class="col-md-2">
